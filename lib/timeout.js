...
var Timeout = function () {
  ...
  var _lastExecuted = function lastExecuted(key) {
    return logdata[key] && logdata[key].lastExecuted ? new Date(logdata[key].lastExecuted) : null;
  ...
  var instantiate = function instantiate(ctorFunc) {
    ...
    return {
      ...
      lastExecuted: function lastExecuted() {
        return _lastExecuted(key);
      },
