...
var Timeout = function () {
  ...
  var instantiate = function instantiate(ctorFunc) {
    ...
    for (var _len2 = arguments.length, ctorCallbackParams = new Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 < _len2; _key2++) {
      ctorCallbackParams[_key2 - 2] = arguments[_key2];
    }
    ...
    return {
      ...
      set: function set(newFunc) {
        ...
        for (var _len3 = arguments.length, newParams = new Array(_len3 > 2 ? _len3 - 2 : 0), _key3 = 2; _key3 < _len3; _key3++) {
          newParams[_key3 - 2] = arguments[_key3];
        }
